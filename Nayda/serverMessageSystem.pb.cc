...
class ServerSendRoomCreationLobbyChartMessageDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ServerSendRoomCreationLobbyChartMessage>
      _instance;
...
class ClientSendRoomCreationLobbyChartMessageDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<ClientSendRoomCreationLobbyChartMessage>
      _instance;
...
static void InitDefaultsServerSendRoomCreationLobbyChartMessage() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_ServerSendRoomCreationLobbyChartMessage =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsServerSendRoomCreationLobbyChartMessage}, {
      &protobuf_serverMessageSystem_2eproto::scc_info_CommonHeader.base,}};

static void InitDefaultsClientSendRoomCreationLobbyChartMessage() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_ClientSendRoomCreationLobbyChartMessage =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsClientSendRoomCreationLobbyChartMessage}, {
      &protobuf_serverMessageSystem_2eproto::scc_info_CommonHeader.base,}};
...
void InitDefaults() {
  ...
  ::google::protobuf::internal::InitSCC(&scc_info_ServerSendRoomCreationLobbyChartMessage.base);
  ::google::protobuf::internal::InitSCC(&scc_info_ClientSendRoomCreationLobbyChartMessage.base);
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage, header_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage, connectioncmdid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage, opponentname_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage, chartmessage_),
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage, header_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage, connectioncmdid_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage, clientname_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage, chartmessage_),
};
...
ServerSendRoomCreationLobbyChartMessage::ServerSendRoomCreationLobbyChartMessage()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_serverMessageSystem_2eproto::scc_info_ServerSendRoomCreationLobbyChartMessage.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* ServerSendRoomCreationLobbyChartMessage::descriptor() {
  ::protobuf_serverMessageSystem_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_serverMessageSystem_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ServerSendRoomCreationLobbyChartMessage& ServerSendRoomCreationLobbyChartMessage::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_serverMessageSystem_2eproto::scc_info_ServerSendRoomCreationLobbyChartMessage.base);
  return *internal_default_instance();
}
...
// @@protoc_insertion_point(generalized_merge_from_start:serverMessageSystem.ServerSendRoomCreationLobbyChartMessage)
  ...
  const ServerSendRoomCreationLobbyChartMessage* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const ServerSendRoomCreationLobbyChartMessage>(
          &from);
  if (source == NULL) {
...
ClientSendRoomCreationLobbyChartMessage::ClientSendRoomCreationLobbyChartMessage()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_serverMessageSystem_2eproto::scc_info_ClientSendRoomCreationLobbyChartMessage.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* ClientSendRoomCreationLobbyChartMessage::descriptor() {
  ::protobuf_serverMessageSystem_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_serverMessageSystem_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const ClientSendRoomCreationLobbyChartMessage& ClientSendRoomCreationLobbyChartMessage::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_serverMessageSystem_2eproto::scc_info_ClientSendRoomCreationLobbyChartMessage.base);
  return *internal_default_instance();
}
...
// @@protoc_insertion_point(generalized_merge_from_start:serverMessageSystem.ClientSendRoomCreationLobbyChartMessage)
  ...
  const ClientSendRoomCreationLobbyChartMessage* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const ClientSendRoomCreationLobbyChartMessage>(
          &from);
  if (source == NULL) {
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage* Arena::CreateMaybeMessage< ::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage >(Arena* arena) {
  return Arena::CreateInternal< ::serverMessageSystem::ServerSendRoomCreationLobbyChartMessage >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage* Arena::CreateMaybeMessage< ::serverMessageSystem::ClientSendRoomCreationLobbyChartMessage >(Arena* arena) {
