...
//Структуры-наполнения для различных слеекторов
//Передаваться в конструктор общего слектора будет
//Целиковая структура, но не все её поля будут заполнены -
//По типу переданного значения конструктор определит, к какому на самом деле
