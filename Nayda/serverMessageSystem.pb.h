...
enum CardPlayDirection {
  ...
  CardPlayDirection_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  CardPlayDirection_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class ClientHasImplementedCard : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:serverMessageSystem.ClientHasImplementedCard) */ {
 public:
  ...
  private:
  const ::serverMessageSystem::SimpleCard& _internal_card() const;
  public:
...
inline const ::serverMessageSystem::CommonHeader& ClientHasImplementedCard::_internal_header() const {
  return *header_;
}
...
inline const ::serverMessageSystem::SimpleCard& ClientHasImplementedCard::_internal_card() const {
  return *card_;
}
