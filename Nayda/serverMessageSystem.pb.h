...
inline const ::serverMessageSystem::CommonHeader& ServerSendRoomCreationLobbyChartMessage::_internal_header() const {
  return *header_;
}
...
inline const ::serverMessageSystem::CommonHeader& ClientSendRoomCreationLobbyChartMessage::_internal_header() const {
  return *header_;
}
